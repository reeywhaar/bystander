...
// declare it. A package here — rather than in main — keeps main.go at ten lines and lets
// internal/api take an fs.FS parameter, so its tests can drive a synthetic fstest.MapFS
// and exercise the fallback rules precisely, which is better than testing against
